    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center">
          ...
          <span className="text-lg font-semibold text-gray-900">Serikat Pekerja Kampus</span>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              <div className="flex items-center mb-4">
                ...
                <span className="text-lg font-semibold">Survei Serikat Pekerja Kampus</span>
              </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                ...
                <a href="#" className="block text-gray-300 hover:text-white transition-colors">Login</a>
                <a href="#" className="block text-gray-300 hover:text-white transition-colors">Register</a>
              </div>
            </div>
